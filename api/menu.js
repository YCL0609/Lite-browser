...
const menuTemplate = [
  ...
  },
  {
    ...
    submenu: [
      ...
      {
        label: '刷新(F5)', accelerator: 'F5', role: 'reload'
      },
      // Mac 环境下
      ...(isMac ? [forceReload] : []),
      {
...
// 非 Mac 环境下
if (!isMac) {
  menuTemplate.push(forceReload);
  menuTemplate.push(jsInjectionItem);
}
